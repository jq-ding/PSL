...
from tensorflow.keras.layers import Dense, Input, Conv2D, AveragePooling2D, GlobalAveragePooling2D, BatchNormalization, Activation, Dropout, concatenate
...
def DenseNet40_BC():
    ...
    # initial convolution
    x = Conv2D(24, (3, 3), padding='same', use_bias=False, kernel_regularizer=regularizers.l2(weight_decay), name='initial_conv')(img_input)
